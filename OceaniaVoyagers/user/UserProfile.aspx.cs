...
namespace OceaniaVoyagers.user
{
    public partial class UserProfile : System.Web.UI.Page
    {
        ...
        //DataTable dtcontact, dtaddress = new DataTable();
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    txtFirstName.Text = dr["user_fname"].ToString();
                    txtLastName.Text = dr["user_lname"].ToString();
            ...
            public void Fill_City_Combo(int id)
            {
                ...
                ddcity.Items.Clear();
                ddcity.Items.Add(new ListItem("SELECT", "0"));
        ...
        protected void btnupdateuser_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (imgProfile.HasFile)
                {
                    ...
                    imgName = Session["LoginUserId"].ToString() + "_" + txtFirstName.Text.ToString() + "_" + DateTime.Now.ToString("dd_MM_yy_HH_mm_ss") + ext;
                ...
                Session["LoginUserName"] = txtFirstName.Text.ToString().Trim() + " " + txtLastName.Text.ToString().Trim();
               ...
               if (ViewState["imgState"].ToString() != "")
                ...
                {
                    this.ClientScript.RegisterStartupScript(this.GetType(), "SweetAlert", "swal('Successful!',' Your Account is information is update.', 'success');", true);
