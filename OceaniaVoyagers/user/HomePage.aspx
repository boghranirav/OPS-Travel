                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-10 search-col-padding">
                                                    ...
                                                    <div class="input-group">
                                                        <asp:TextBox ID="txtDestination" class="form-control" aria-describedby="wantgo" 
                                                            placeholder="E.g. Auckland" runat="server" onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                ...
                                <div class="list-items grid col-md-12">
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="item-details">
                                            ...
                                            <asp:Button runat="server" ID="linkPackSearch" Text="Search" OnClick="linkPackSearch_Click"
                                                CssClass="btn btn-theme xs-btn"></asp:Button>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                </div>
