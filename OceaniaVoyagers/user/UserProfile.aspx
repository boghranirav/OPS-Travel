                                    ...
                                    <table style="width: 100%;">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <label>Country</label>
                                                    <asp:DropDownList ID="ddCountry" class="form-control" runat="server" TabIndex="7" AutoPostBack="true" OnSelectedIndexChanged="ddCountry_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="form-group">
                                                    <label>City</label>
                                                    <asp:DropDownList ID="ddcity" class="form-control" runat="server" TabIndex="9">
                                                    </asp:DropDownList>
                                                </div>
                                            </td>
                                        </tr>
