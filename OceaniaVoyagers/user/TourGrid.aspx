                                    ...
                                    <ItemTemplate>
                                        <div class="col-md-6 col-sm-6">
                                            <div class="room-grid-view">
                                                <div class="offer-ribbon" runat="server" visible='<%#(Eval("discountType").ToString()) =="1" %>'>
                                                    <span><%# Math.Ceiling(decimal.Parse(Eval("discount").ToString())) %> % Off </span>
                                                </div>
                                                <div class="offer-ribbon" runat="server" visible='<%#(Eval("discountType").ToString() == "2") %>'>
                                                    <span><%# Eval("discount") %> NZD Off </span>
                                                </div>
                                                ...
                                                <div class='room-info'>
                                                    ...
                                                    <div class='room-desc'>
                                                        <p class='mb-1'><i class='fa fa-fw fa-calendar'></i>
                                                            <strong>Number of Days</strong>:  <%#Eval("totaldays") %> </p>
                                                        <p class='mb-1'><i class='fa fa-fw fa-map-marker'></i>
                                                            <strong>Starting Point</strong>:  <%#Eval("fromC") %>  </p>
                                                    ...
                                                    <div class='room-book'>
                                                        <div class='row'>
                                                            <div class='col-md-6 center-div' style="border-right: 1px solid #000e2b">
                                                                <h5>$ <%#Eval("adultprice") %> <span>NZD Per Person</span></h5>
                                                            </div>
                                                            <div class='col-md-6 center-div'>
                                                                <asp:Label runat="server" ID="lblPId" Visible="false" Text='<%# Eval("packageid") %>'></asp:Label>
                                                                <asp:Button runat="server" ID="linkDetails" Text="Details" OnClick="linkDetails_Click" 
                                                                    CssClass="btn btn-theme p-sm-3"></asp:Button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <ItemTemplate>
                                                    <li class='page-item <%# Convert.ToBoolean(Eval("Enabled")) ? "" : "active" %>'>
                                                        <asp:LinkButton ID="lnkPage" runat="server" Text='<%#Eval("Text") %>' CommandArgument='<%# Eval("Value") %>'
                                                            CssClass='page-link'
                                                            OnClick="lnkPage_Click" OnClientClick='<%# !Convert.ToBoolean(Eval("Enabled")) ? "return false;" : "" %>'>
                                                        </asp:LinkButton>
                                                    </li>
                                                </ItemTemplate>
                                            </asp:Repeater>
