                                ...
                                <div class='col-lg-12'>
                                    <div class='hotel-box-view wide-view'>
                                        ...
                                        <div class='hotel-box-view-body'>
                                            ...
                                            <div class='price' style='margin-top: 10px; margin-left: 20px'><span><%#Eval("adultprice") %></span> per Person</div>
                                            <p class='mb-1' style='margin-left: 20px' runat="server" visible='<%#(Eval("datetype").ToString()) !="No" %>' ><i class='fa fa-fw fa-calendar'></i><strong>Valid From </strong>: <%#Eval("validfrom","{0:dd-MMM-yyyy}") %></p>
                                            <p class='mb-1' style='margin-left: 20px' runat="server" visible='<%#(Eval("datetype").ToString()) !="No" %>'><i class='fa fa-fw fa-calendar'></i><strong>Valid To</strong> &nbsp;&nbsp;&nbsp;&nbsp;: <%#Eval("validto","{0:dd-MMM-yyyy}") %></p>
                                            <p class='mb-1' style='margin-left: 20px' runat="server" visible='<%#(Eval("website").ToString()) !="" %>'><strong>Website</strong>: <a href="https://<%#Eval("website") %>" target="_blank"><%#Eval("website") %></a></p>
                                            <p style='bottom: 0px; position: absolute; margin-left: 20px'>
                                                ...
                                                <asp:Button runat="server" ID="linkDetails" Text="View Detail" OnClick="linkDetails_Click" CssClass="btn btn-theme p-sm-3"></asp:Button>
                                            </p>
                                        </div>
                                    </div>
                                </div>
