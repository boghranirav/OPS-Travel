        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-6 center-div text-center" style="background-color: #000e2b; border-radius: 40px; padding: 15px; font-family: 'Aclonica', sans-serif;">
                    <h4 style="color: #fff; text-transform: capitalize">booking details</h4>
                    <p>Your Selected Packages , Activities & Enquiry</p>
                </div>
            </div>
        </div>
    </section>
                        ...
                        <div class="hotel-tab-detail">
                            <div class="theme-tab">
                                ...
                                <ul class="nav nav-tabs nav-fill tab-style2">
                                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#overview"><i class="fa fa-bolt"></i><span>Tour Package Details</span></a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#schedule"><i class="fa fa-info-circle"></i><span>Activity Details</span></a></li>
                                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#included"><i class="fa fa-check"></i><span>Custom Package</span></a></li>
                                </ul>
                            </div>
                            <div class="tab-content">
                                <div id="overview" class="tab-pane fade show active">
                                    <asp:GridView ID="grdPackage" runat="server"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="packagedate" HeaderText="Package Date" ReadOnly="true" ItemStyle-Width="10%" DataFormatString="{0:dd-MMM-yyyy}" />
                                            <asp:BoundField DataField="enquirytime" HeaderText="Enquiry Date" ReadOnly="true" ItemStyle-Width="10%" DataFormatString="{0:dd-MMM-yyyy}" />
                                            ...
                                            <asp:BoundField DataField="totalpayment" HeaderText="Total Amount (NZD)" ReadOnly="true" ItemStyle-Width="10%" ItemStyle-HorizontalAlign="Right" />
                                ...
                                <div id="schedule" class="tab-pane fade">
                                    <asp:GridView ID="grdActivity" runat="server"
                                        ...
                                        Width="100%">
                                        <Columns>
                                            <asp:BoundField DataField="activityname" HeaderText="Activity Name" ReadOnly="true" ItemStyle-Width="10%" />
                                            ...
                                            <asp:BoundField DataField="booktime" HeaderText="Book Date" ReadOnly="true" ItemStyle-Width="10%" DataFormatString="{0:dd-MMM-yyyy}" />
                                ...
                                <div id="included" class="tab-pane fade">
                                    <asp:GridView ID="grdcustomPackage" runat="server"
                                        ...
                                        Width="100%">
                                        <Columns>
                                            <asp:BoundField DataField="departure" HeaderText="Departure City Name" ReadOnly="true" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="dest" HeaderText="Destination City Name" ReadOnly="true" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="hname" HeaderText="Hotel Type Name" ReadOnly="true" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="startdate" HeaderText="Start Date" ReadOnly="true" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="enddate" HeaderText="End Date" ReadOnly="true" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="budget" HeaderText="Budget" ReadOnly="true" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="description" HeaderText="Description" ReadOnly="true" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="createdate" HeaderText="Inquiry Date" ReadOnly="true" DataFormatString="{0:dd-MMM-yyyy}" ItemStyle-Width="10%" />
                                            <asp:BoundField DataField="replydate" HeaderText="Reply Date" ReadOnly="true" DataFormatString="{0:dd-MMM-  yyyy}" ItemStyle-Width="10%" />
