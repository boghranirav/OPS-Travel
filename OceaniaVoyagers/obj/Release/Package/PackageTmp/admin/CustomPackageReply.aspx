                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            <label class="col-md-2 control-label">Hotel Type</label>
                            <div class="col-md-3">
                                <asp:Label ID="lblHotelType" runat="server" Text="Label"></asp:Label>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="col-md-2 control-label">Adult Member</label>
                            <div class="col-md-3">
                                <asp:Label ID="lblAdultMember" runat="server" Text="Label"></asp:Label>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-2 control-label">Child Member</label>
                            <div class="col-md-3">
