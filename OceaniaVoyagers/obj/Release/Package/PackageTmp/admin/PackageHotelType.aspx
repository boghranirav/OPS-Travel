                ...
                <div class="panel panel-inverse">
                    ...
                    <div class="panel-body panel-form">
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <asp:DropDownList ID="cmbPackage" runat="server" class="form-control col-md-3" OnSelectedIndexChanged="cmbPackage_SelectedIndexChanged" AutoPostBack="true">
                                    <asp:ListItem Value="0">SELECT</asp:ListItem>
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator2" ControlToValidate="cmbPackage" InitialValue="0" ForeColor="Red" ErrorMessage="* Select Package." Display="Dynamic"></asp:RequiredFieldValidator> 
                            </div>
                        </div>
                                            ...
                                            <asp:TemplateField HeaderText="Enter Price" HeaderStyle-Width="30%" >
                                                <ItemTemplate>
                                                    <div class="col-md-1 col-sm-1">
                                                        <asp:TextBox ID="txtPrice" runat="server" Width="4cm" MaxLength="10" style="text-align:right" Text='<%# Eval("price") %>' />
                                                        <asp:RequiredFieldValidator runat="server" Display="Dynamic" ID="RequiredFieldValidator1" ControlToValidate="txtPrice" ErrorMessage="*EnterPrice." ForeColor="Red"></asp:RequiredFieldValidator>
                                                        <asp:RegularExpressionValidator runat="server" Display="Dynamic"  ID="RegularExpressionValidator1" ControlToValidate="txtPrice" ForeColor="Red" ErrorMessage="*InvalidNumber" ValidationExpression="\d+(\.\d{1,2})?"></asp:RegularExpressionValidator> 
                                                    </div>
                                                </ItemTemplate>
                                            </asp:TemplateField>
