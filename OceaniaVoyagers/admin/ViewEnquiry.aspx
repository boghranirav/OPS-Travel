                    ...
                    <div class="panel-body">
                        <div class="table-responsive">
                            <asp:GridView ID="grdCustomerEnquiry" CssClass="table table-striped table-bordered"
                                ...
                                Width="100%">
                                <Columns>
                                    <asp:BoundField DataField="name" HeaderText="User Name" ReadOnly="true" ItemStyle-Width="10%" />
                                    <asp:BoundField DataField="mobileno" HeaderText="Mobile Number" ReadOnly="true" ItemStyle-Width="10%" />
                                    <asp:BoundField DataField="email" HeaderText="Email Id" ReadOnly="true" ItemStyle-Width="10%" />
                                    <asp:BoundField DataField="description" HeaderText="Description" ReadOnly="true" ItemStyle-Width="60%" />
