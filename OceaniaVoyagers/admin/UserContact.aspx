                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="grdCustomPackage" CssClass="table table-striped table-bordered"
                                ...
                                Width="100%">
                                    ...
                                    <asp:BoundField DataField="adultmember" HeaderText="Adults" ReadOnly="true" ItemStyle-Width="4%" />
                                    <asp:BoundField DataField="childmember" HeaderText="Children" ReadOnly="true" ItemStyle-Width="4%" />
                                    ...
                                    <asp:BoundField DataField="description" HeaderText="Requirements" ReadOnly="true" ItemStyle-Width="20%" />
                                        ...
                                        <ItemTemplate>
                                            <asp:LinkButton ID="InkEdit" runat="server" class="fa fa-reply" Font-Size="X-Large" CommandName="Select" CommandArgument='<%#Bind("custompackageid") %>'>
                                            </asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
